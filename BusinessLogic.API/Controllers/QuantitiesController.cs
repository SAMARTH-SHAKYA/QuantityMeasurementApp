...
namespace BusinessLogic.API.Controllers
{
    ...
    public class QuantitiesController : ControllerBase
    {
        ...
        private readonly IDataRepositoryClient _repository;
        private readonly IDistributedCache _cache;
        private const string HistoryCacheKey = "MeasurementHistory";

        public QuantitiesController(IQuantityMeasurementService service, IDataRepositoryClient repository, IDistributedCache cache)
        {
            _service = service;
        ...
        public async Task<ActionResult<List<QuantityMeasurementEntity>>> GetHistory()
        {
            try
            {
                ...
                var results = await _repository.GetAllMeasurementsAsync();
