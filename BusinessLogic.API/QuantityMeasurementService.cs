...
namespace QuantityMeasurementApp.Service
{
    ...
    {
        private readonly IDataRepositoryClient repository;

        public QuantityMeasurementService(IDataRepositoryClient repository)
        {
        ...
        public QuantityDTO Compare(QuantityDTO q1, QuantityDTO q2)
        {
            try
            {
                ...
                var entity = new QuantityMeasurementEntity(
                    ...
                    resultString,
                    q1.MeasurementType);
                repository.SaveMeasurementAsync(entity).Wait();
